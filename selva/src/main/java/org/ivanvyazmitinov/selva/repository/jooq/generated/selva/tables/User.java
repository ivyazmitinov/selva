...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The reference instance of <code>selva.user</code>
     */
    ...
    /**
     * The column <code>selva.user.id</code>.
     */
    public final TableField<UserRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>selva.user.username</code>.
     */
    public final TableField<UserRecord, String> USERNAME = createField(DSL.name("username"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>selva.user.password</code>.
     */
    public final TableField<UserRecord, String> PASSWORD = createField(DSL.name("password"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>selva.user.role</code>.
     */
    public final TableField<UserRecord, Role> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(Role.class), this, "");

    /**
     * The column <code>selva.user.finished_registration</code>.
     */
    public final TableField<UserRecord, Boolean> FINISHED_REGISTRATION = createField(DSL.name("finished_registration"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field(DSL.raw("false"), SQLDataType.BOOLEAN)), this, "");
    ...
    /**
     * Create an aliased <code>selva.user</code> table reference
     */
    ...
    /**
     * Create a <code>selva.user</code> table reference
     */
    public User() {
    ...
    /**
     * Get the implicit to-many join path to the <code>selva.base_profile</code>
     * table
     */
    public BaseProfilePath baseProfile() {
        if (_baseProfile == null)
            _baseProfile = new BaseProfilePath(this, null, Keys.BASE_PROFILE__BASE_PROFILE_USER_ID_FKEY.getInverseKey());
